...
function StudentAcademicProgressStep() {
	...
	return (
		<>
			...
			<TextField
				control={form.control}
				name="schoolNumeracyScore"
				placeholder="Numeracy Score"
				min={0}
				step={1}
				type="number"
			/>

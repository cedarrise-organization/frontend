	...
	return (
		<DropdownMenuPrimitive.Item
			...
			className={cnMerge(
				...
				focus:bg-shadcn-accent focus:text-shadcn-accent-foreground data-[variant=destructive]:text-shadcn-destructive
				data-[variant=destructive]:focus:bg-shadcn-destructive/10 data-[variant=destructive]:focus:text-shadcn-destructive

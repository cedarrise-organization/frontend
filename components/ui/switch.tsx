	...
	return (
		<SwitchPrimitive.Root
			...
			className={cnMerge(
				...
				data-[size=sm]:h-3.5 data-[size=sm]:w-6 dark:aria-invalid:border-shadcn-destructive/50
				dark:aria-invalid:ring-shadcn-destructive/40 data-checked:bg-shadcn-primary
				data-unchecked:bg-shadcn-input dark:data-unchecked:bg-shadcn-input/80
		...
		>
			<SwitchPrimitive.Thumb
				...
				className={cnMerge(
					...
					dark:data-unchecked:bg-shadcn-foreground`,
					classNames?.thumb
				)}
			/>
		</SwitchPrimitive.Root>

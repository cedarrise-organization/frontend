	...
	return (
		<SwitchPrimitive.Root
			...
			className={cnMerge(
				...
				aria-invalid:ring-shadcn-destructive/20 data-[size=default]:h-[18.4px]
				data-[size=default]:w-8 data-[size=sm]:h-3.5 data-[size=sm]:w-6
				dark:aria-invalid:border-shadcn-destructive/50 dark:aria-invalid:ring-shadcn-destructive/40 data-checked:bg-shadcn-primary data-unchecked:bg-shadcn-input
				dark:data-unchecked:bg-shadcn-input/80 data-disabled:cursor-not-allowed
		...
		>
			<SwitchPrimitive.Thumb
				...
				className={cnMerge(
					...
					dark:data-checked:bg-shadcn-primary-foreground
					group-data-[size=default]/switch:data-unchecked:translate-x-0
					group-data-[size=sm]/switch:data-unchecked:translate-x-0 dark:data-unchecked:bg-shadcn-foreground`,
					classNames?.thumb
				)}
			/>
		</SwitchPrimitive.Root>
